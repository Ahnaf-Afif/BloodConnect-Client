  ...
  return (
    <div className="grid gap-6 md:grid-cols-3 my-8">
      <div className="group relative rounded-2xl bg-white p-6 shadow-lg ring-1 ring-[#f0d3cf]/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-red-500/10 rounded-full -mr-10 -mt-10"></div>
        <div className="relative z-10">
          ...
          <p className="text-xs text-green-600 mt-2 font-semibold">↑ 12% this month</p>
        </div>
      </div>

      <div className="group relative rounded-2xl bg-white p-6 shadow-lg ring-1 ring-[#f0d3cf]/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-blue-500/10 rounded-full -mr-10 -mt-10"></div>
        <div className="relative z-10">
          ...
          <p className="text-xs text-green-600 mt-2 font-semibold">↑ 8% this month</p>
        </div>
      </div>

      <div className="group relative rounded-2xl bg-white p-6 shadow-lg ring-1 ring-[#f0d3cf]/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-amber-500/10 rounded-full -mr-10 -mt-10"></div>
        <div className="relative z-10">
          ...
          <p className="text-xs text-green-600 mt-2 font-semibold">↑ 15% this month</p>
        </div>
      </div>
    </div>
  );
